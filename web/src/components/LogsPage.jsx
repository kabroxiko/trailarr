    ...
    <div style={{ padding: "2em" }}>
      ...
      >
        ...
        <span style={{ fontWeight: 600 }}>
          {logDir || "[log directory not available]"}
        </span>
        <br />
        The log level defaults to 'Debug' and can be changed in{" "}
        <Link
          to="/settings/general"
          style={{
      ...
      >
        <thead>
          <tr style={{ background: tableHeaderBg, color: textColor }}>
            ...
            <th style={{ textAlign: "left", padding: "0.75em" }}>
              Last Write Time
            </th>
          ...
          {loading ? (
            ...
            logs.map((log) => (
              ...
              >
                ...
                >
                  {formatLogDate(log.lastWrite)}
                </td>
                <td style={{ padding: "0.75em", textAlign: "left" }}>
                  <a
                    href={`/logs/${encodeURIComponent(log.filename)}`}
                    target="_blank"
