    ...
    <>
      {open && (
        <button
          ...
          style={{ background: 'transparent', border: 'none', padding: 0, margin: 0, position: 'fixed', top: 0, left: 0, width: '100vw', height: '100vh', zIndex: 1000 }}
        />
      )}
      <div className={`sidebar-mobile${open ? ' open' : ''}`} style={{ '--sidebar-bg': darkMode ? '#23232a' : '#fff', position: 'fixed', zIndex: 1001 }}>
        <nav>
